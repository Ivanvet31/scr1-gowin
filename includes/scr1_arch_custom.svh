...
`define SCR1_PTFM_CORE_CLK_FREQ     32'd50000000 // 50MHz
...
parameter bit [`SCR1_XLEN-1:0]          SCR1_ARCH_RST_VECTOR        = 'hF0000000;   // TCM start
parameter bit [`SCR1_XLEN-1:0]          SCR1_ARCH_MTVEC_BASE        = 'hF0000080;   // TCM irq
